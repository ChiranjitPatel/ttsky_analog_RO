...
#set source [readnet verilog ../src/project.v]
...
readnet spice ../xschem/simulation/ring_20.spice $source
readnet spice ../xschem/simulation/sky130_hd_nand2_1.spice $source
